...
Funktion: Heltec WiFi LoRa 32 (V2) ntp Datum und Zeit
Version: 09.03.2021
...
#define   TIME_ZONE                     (+1)                                // offset from utc BERLIN
...
char      chSSID[] =                      "xxx";                   // your network SSID
char      chPassword[] =                  "xxx";               // your network password
